...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.soapy_hackrf_source_0.set_gain(0, 'VGA', min(max(8, 0.0), 62.0))
        ...
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink(
            'C:\\Users\\antoi\\Desktop\\TestLoRaSDR\\Wav\\Real.wav',
            1,
            samp_rate,
            blocks.FORMAT_WAV,
        ...
        self.connect((self.soapy_hackrf_source_0, 0), (self.blocks_complex_to_real_0, 0))
